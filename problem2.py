...
def temperature_converter():
    ...
    Unit = input("Current unit (C or F):")
    while Unit !="C" and Unit!="F":
        print("The unit has to be in celsius or farenheit")
        Unit = input("Current unit (C or F):")
    if Unit =="C":
        return print(celsius_to_fahrenheit(C))
    elif Unit =="F":
        return print(fahrenheit_to_celsius(C))
